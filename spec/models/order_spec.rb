...
RSpec.describe Order, type: :model do
  ...
  describe "#build_placement_with_products_ids_and_quantity" do
    before(:each) do
    ...
    it "builds 2 placements for the order" do
      expect{order.build_placement_with_product_ids_and_quantities(@product_ids_and_quantities)}.to change{order.placements.size}.from(0).to(2)
    end
  end
  ...
  describe "#valid?" do
    ...
    it "becomes invalid due to insifficient products" do
